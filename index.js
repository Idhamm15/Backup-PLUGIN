...
app.get("/express/foods/:id", (req,res) => {
    let {id} = req.params;
...
app.delete("/express/foods/:id", (req,res) =>{
    let {id} = req.params;
...
app.put("/express/foods/:id", (req,res) => {
    let sql = "UPDATE foods SET nama_makanan='"+req.body.nama_makanan+"', harga='"+req.body.harga+"' WHERE id="+req.params.id;
    koneksiDB.query(sql, (err,result) =>{
        if(err) {
            res.send({
                msg: "edit data error",
